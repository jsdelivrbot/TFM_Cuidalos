...
var width = 1064;
 ...
 var picturesShapes = [];
            ...
            (function() {
                ...
                picture.on('dragend', function() {
                    ...
                    if(!picture.inRightPlace && isNearOutline(picture, outline)) {
                        ...
                        {
                        	case 'sec1':
                        		writeMessage('¡Correcto! Primero comprobamos si la víctima está consciente.');
                        		break;
                        	case 'sec2':
                        		writeMessage('¡Correcto! Colocamos a la víctima en una posición cómoda y segura (evitar ahogamiento con la lengua).');
                        		break;
                        	case 'sec3':
                        		writeMessage('¡Correcto! Preguntamos a la víctima donde le duele y comprobamos la zona.');
                        		break;
                        	case 'sec4':
                        		writeMessage('¡Correcto! Observamos si puede existir fractura. En caso de palpar, con mucho cuidado si hay duda de fractura.');
                        		break;
                        	case 'sec5':
                        		writeMessage('¡Correcto! Tranquilizamos a la víctima, tanto si existe rotura como si no.');
                        		break;
                        	case 'sec6':
                        		writeMessage('¡Correcto! Si existe fractura llamamos a urgencias. Si no la hay, intentamos levantar con mucho cuidado a la víctima.');
                        		break;
                        }
                        ...
                        if(++score >= 6) {
                        	...
                        	document.getElementById('guardar_caida_tiempo').value = ((end.getTime()-start.getTime())/1000);
                        	document.getElementById('guardar_caida_orden').value = orden;
                        	document.getElementById('guardar_caida_error').value = error;
                        	setTimeout(function(){document.forms[0].submit();}, 6000);
                        	
                            //window.location = ("../html/score_secuence2.html");
                        }
    ...
    var sources = {
        ...
        sec1: 'images/secuencia_caida_1.png',
        sec1_glow: 'images/secuencia_caida_borde_1.png',
        sec1_white: 'images/panel_blanco_secuencia_1.png',
        sec2: 'images/secuencia_caida_2.png',
        sec2_glow: 'images/secuencia_caida_borde_2.png',
        sec2_white: 'images/panel_blanco_secuencia_2.png',
        sec3: 'images/secuencia_caida_3.png',
        sec3_glow: 'images/secuencia_caida_borde_3.png',
        sec3_white: 'images/panel_blanco_secuencia_3.png',
        sec4: 'images/secuencia_caida_4.png',
        sec4_glow: 'images/secuencia_caida_borde_4.png',
        sec4_white: 'images/panel_blanco_secuencia_4.png',
        sec5: 'images/secuencia_caida_5.png',
        sec5_glow: 'images/secuencia_caida_borde_5.png',
        sec5_white: 'images/panel_blanco_secuencia_5.png',
        sec6: 'images/secuencia_caida_6.png',
        sec6_glow: 'images/secuencia_caida_borde_6.png',
